...
#training['features'], training['sequences'] = read_seq_pssm("pssm_dimers_936_list.tsv","dimers_936")
#training['contacts'] = read_contacts("rri_dimers_936_list.tsv","dimers_936_rri",training['features'])
#training['scop'] = read_scop("936_hetero_homo_dimers_list.tsv")
...
class BiLSTM(nn.Module):
    ...
    def forward( self, pdb, sequence_r, sequence_l, features, contacts, ch_r=None, ch_l=None, Flag=True ):
        ...
        if Flag:
          ...
          hidden_3_3t = self.batchNorm_3( 0.5*(hidden_3+hidden_3_t) )
          out_hidden_3 = F.relu(hidden_3_3t)
