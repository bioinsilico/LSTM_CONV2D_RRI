...
training['features'], training['sequences'] = read_seq_pssm("pssm_dimers_450_list.tsv","dimers_450",hydro=True)
...
testing['features'], testing['sequences'] = read_seq_pssm("pssm_dimers_bipspi_list.tsv","dimers_bipspi",hydro=True)
